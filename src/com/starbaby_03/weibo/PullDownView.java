...
public class PullDownView extends LinearLayout implements OnScrollOverListener{
	...
	private static final int WHAT_DID_MORE2 = 6;			// Handler what 已经获取完更多,没有新内容了
	...
	/**
	 * 通知已经没有新的内容获取了，要放在Adapter.notifyDataSetChanged后面
	 * 当你执行完更多任务之后，调用这个notyfyDidMore()
	 * 才会隐藏加载圈等操作
	 */
	...
	private Handler mUIHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				...
				case WHAT_DID_MORE2:{
					mIsFetchMoreing = false;
					mFooterTextView.setText("已经没有新内容了");
					mFooterLoadingView.setVisibility(View.GONE);
				}
			}
		}
